...
This CocoaPods plugin can be found here: Coming soon...
...
* [Swift (CocoaPods plugin)](https://github.com/SequencingDOTcom/CocoaPods-Swift-iOS-plugin) <- this repo
* [Swift (code)](https://github.com/SequencingDOTcom/oAuth2-code-and-demo/tree/master/swift)
* [Objective-C (CocoaPods plugin)](https://github.com/SequencingDOTcom/CocoaPods-Objective-C-iOS-plugin)
...
2) Add this plugin to your iOS app coded in Swift
